 ...
 * HW1 EDIT: START
 * =============*/
	int max_proc_from_above;
	int max_proc_for_children;
	int subtree_size;
	task_t *real_dad, *real_youngest_child, *real_oldest_child;	// Use these because the default
																// behaviour sets orphans to
																// children of the init process
	task_t *older_sibling, *younger_sibling;	// Use these because we don't know if orphaned
												// processes naturally remember their siblings
/* ===============
 * HW1 EDIT: END
 * =============*/
